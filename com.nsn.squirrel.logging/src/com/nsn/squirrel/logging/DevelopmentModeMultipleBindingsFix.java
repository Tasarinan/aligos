 ...
 * command line), the <code>dev.properties</code> file in the <code>workspace/.metadata/.plugins/org.eclipse.pde.core/&lt;product name&gt;</code> directory is used to extend the classpath to include required libraries (see {@link DevClassLoadingHook}). This causes the
 ...
 * <p/>
 * This class applies a fix to the classloader of the {@link LoggerFactory} class that removes any duplicate jars in the classpath.
 *
