...
public class LoggingConfigurator
{
	...
	private static void configureJULBridge(LoggerContext loggerContext)
	{
		...
		//The following api is since 1.6.5
	...
	private static void bypassRuntimeLog(BundleContext context)
	{
		...
		ServiceReference packageAdminRef = context.getServiceReference(org.osgi.service.packageadmin.PackageAdmin.class.getName());
		...
		PlatformLogWriter writer = new PlatformLogWriter(new SLF4JExtendedLogService(), packageAdmin, context.getBundle());
