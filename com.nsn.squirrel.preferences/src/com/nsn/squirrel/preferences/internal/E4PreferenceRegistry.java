 ...
 *******************************************************************************/
package com.nsn.squirrel.preferences.internal;
...
import com.nsn.squirrel.preferences.IPreferenceStoreProvider;
...
public class E4PreferenceRegistry
{
	...
	public static final String PREFS_PAGE_XP = "com.nsn.squirrel.preferences.e4PreferencePages"; // $NON-NLS-1$
	public static final String PREF_STORE_PROVIDER = "com.nsn.squirrel.preferences.e4PreferenceStoreProvider"; // $NON-NLS-1$
	...
	private void initialisePreferenceStoreProviders()
	{
		...
		if(psProviders == null)
		{
			...
			for(IConfigurationElement elmt : registry.getConfigurationElementsFor(PREF_STORE_PROVIDER))
			{
				...
				{
					logger.warn("In extension " + PREF_STORE_PROVIDER + " only one of the two attributes (pluginId or idInWorkbenchContext) must be set. Check the plugin " + declaringBundle);
					continue;
				}
